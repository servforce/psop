...
1. 调用 `psop.compiler.read_skill_source` 读取冻结的 README.md、SKILL.md 和 source bundle。
...
5. 从 frozen source 中抽取 execution goal、applicability、workflow steps、expected evidence、safety constraints、wait checkpoints、completion criteria 和 recovery paths。
