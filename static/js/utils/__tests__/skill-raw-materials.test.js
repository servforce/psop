...
test("skill detail exposes raw materials tab and generation workflow", () => {
  ...
  expect(html).toContain("applyRawMaterialDraftPatch()");
  expect(html).toContain("pskill.builder 已生成可审查 patch");
  expect(html).toContain("rawMaterialGenerationResult.patch?.diff");
  expect(html).toContain("rawMaterialGenerationResult.agent_run?.id");
  expect(html).toContain("rawMaterialGenerationResult.committed_commit_sha");
  expect(html).toContain("rawMaterialGenerationResult.changed_files");
  ...
  expect(skillDetailJs).toContain("rawMaterialDraftMaterialIds()");
  expect(skillDetailJs).toContain("material_ids: this.rawMaterialDraftMaterialIds()");
  expect(skillDetailJs).toContain("rawMaterialDraftPatchFileChanges()");
  expect(skillDetailJs).toContain("canApplyRawMaterialDraftPatch()");
