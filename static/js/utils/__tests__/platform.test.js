...
test("platform methods search and save memory entries", async () => {
  ...
  const entry = {
    ...
    source_refs: [
      { kind: "run", source_run_id: "runtime-run-1" },
      { kind: "run_evaluation", source_evaluation_id: "evaluation-1" },
      { kind: "run_evaluation_finding", source_finding_id: "finding-1", source_evaluation_id: "evaluation-1" },
      ...
      { kind: "run_trace", id: "trace-1", source_run_id: "runtime-run-1", seq_no: 7 },
      { kind: "run_trace", trace_id: "otel-trace-1" },
      { kind: "run_event", id: "run-event-1", source_run_id: "runtime-run-1" },
      { kind: "session_token_snapshot", id: "snapshot-1", source_run_id: "runtime-run-1", seq_no: 3 },
