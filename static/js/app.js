(function () {
  ...
  function buildRunEventsPath(runId) {
  ...
  function buildSkillRunEventsPath(skillId, runId) {
  ...
  function createInitialState() {
    return {
      ...
      materialsLoadedSkillId: null,
      materials: [],
      materialDetail: null,
      materialAnalysis: null,
      materialDetailTab: "analysis",
      materialUploadFiles: [],
      materialUploadItems: [],
      materialUploadSelectedIndex: 0,
      materialUploadNameAutoFilled: false,
      ...
      materialUploadModalOpen: false,
      materialGenerateModalOpen: false,
      materialGenerateForm: {
        user_description: ""
      },
      materialGenerationResult: null,
      ...
      busy: {
        ...
        materialAnalyze: false,
        materialUpload: false,
        materialDelete: false,
        materialGenerate: false,
        materialApply: false,
        ...
        observabilityEventLookup: false,
        observabilityAgentEventLookup: false,
        observabilityToolCallLookup: false,
        observabilityModelCallLookup: false,
        observabilitySkillActivationLookup: false,
        observabilityToolAuthorizationLookup: false,
