...
- `run.event.appended`：新增 `run_event`，用于 Run Live transcript、Run Events 和 Replay timeline 增量更新。
- `run.trace.appended`：新增 `run_trace`，用于 Run Replay timeline、EG Node Path 和可观测排障增量更新。
